...
public class Category {
  ...
  public static List<Category> all() {
    String sql = "SELECT id, names FROM Categories";
  ...
  public boolean equals(Object otherCategory){
    if (!(otherCategory instanceof Category)) {
      ...
      return this.getNames().equals(newCategory.getNames());
    }
  }

  public void save() {
    try(Connection con = DB.sql2o.open()) {
      String sql = "INSERT INTO Categories(names) VALUES (:names)";
      this.id = (int) con.createQuery(sql, true)
      .addParameter("names", this.names)
      .executeUpdate()
      .getKey();
    }
  }
